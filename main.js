var vue = {
    ...
    components: function(){
        ...
        mounted: function(){ 
            ...
            if(component.start_date == "today"){
                console.log("OVO")
                component.dateSettings.startDate = moment().format("DD/MM/YYYY")
            }
            if(component.end_date == "today"){
                component.dateSettings.endDate = moment().format("DD/MM/YYYY")
            }
            ...
            $('#'+ component.name).datepicker({
                ...
                language: 'pt-BR',
                autoclose: true,
                startDate: component.dateSettings.startDate,
                endDate: component.dateSettings.endDate
            });
    ...
    Vue.component("select2", {
        /* Componente: Select2
            ...
            propriedade: [
                ...
                label: Texto do label do componente
                database: Se refere a qual a base de dados será utilizada para exibir as opções
                multiple: Se é possível selecionar mais de uma opção
                search: Se é possível realizar a busca da opção desejada (OBS: Multiple a busca é feita pelo próprio campo)
            ]
        */
        ...
        mounted: function(){
            ...
            uf_select2.select2({
                ...
                minimumResultsForSearch: component.searchSize
            });
